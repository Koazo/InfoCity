...
public class EntertainmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                retrieveJson("шоу-программы",country,API_KEY);
            }
        });
        retrieveJson("шоу-программы",country,API_KEY);
        ...
        call.enqueue(new Callback<Headines>() {
            ...
            public void onResponse(Call<Headines> call, Response<Headines> response) {
                if(response.isSuccessful() && response.body().getArticles() != null){
                    ...
                    adapter = new Adapter(EntertainmentActivity.this, articles);
            ...
            public void onFailure(Call<Headines> call, Throwable t) {
                swipeRefreshLayout.setRefreshing(false);
                Toast.makeText(EntertainmentActivity.this,t.getLocalizedMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    {
        Intent intent = new Intent( EntertainmentActivity.this, SearchActivity.class );
