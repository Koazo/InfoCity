...
public class SportsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                retrieveJson("спорт",country,API_KEY);
            }
        });
        retrieveJson("спорт",country,API_KEY);
        ...
        call.enqueue(new Callback<Headines>() {
            ...
            public void onResponse(Call<Headines> call, Response<Headines> response) {
                if(response.isSuccessful() && response.body().getArticles() != null){
                    ...
                    adapter = new Adapter(SportsActivity.this, articles);
            ...
            public void onFailure(Call<Headines> call, Throwable t) {
                swipeRefreshLayout.setRefreshing(false);
                Toast.makeText(SportsActivity.this,t.getLocalizedMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    {
        Intent intent = new Intent( SportsActivity.this, SearchActivity.class );
